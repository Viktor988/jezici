...
function open_res_info(res){
  ...
  if(res.services.length || res.addons_list.length){
    ...
    <div class='res_info_item'>
      <div class='res_info_tooltip_container'>
        ...
        <div class='res_info_tooltip biggest'> Dodatne usluge </div>
      </div>
  ...
  if(res.guests.length > 0){
      ...
      guest_html = `<div onclick='open_guest_info(${res.guests[0].id})'> ${res.guests[0].name} ${res.guests[0].surname} ${country_html} </div>`;
  ...
  if(res.status == 1)
  {
    guest_status_html = `<select class='basic_select' id='res_info_guest_status'>
      ...
      <option value='arrived'> Došao </option>
      <option value='arrived_and_paid'> Došao i platio </option>
      <option value='left'> Otišao </option>
    </select>`;
  }
  ...
  $("body").append(`
    <div class='info' id='res_info'>
        ...
        <div class='res_info_section'>
          ...
          <div class='flex_start'>
            ...
            <div class='res_info_item'>
              <div class='res_info_tooltip_container'>
                <img class='res_info_icon' src='img/price_tag_white.svg'>
                <div class='res_info_tooltip bigger'> Cijena noćenja </div>
              </div>
              <div class='res_info_text'> ${night_price.toFixed(2)} ${currency} p/n </div>
            </div>
          </div>
          <div class='flex_start'>
            <div class='res_info_item'>
            ...
            <div class='res_info_item'>
              <div class='res_info_tooltip_container'>
                ...
                <div class='res_info_tooltip big'> Odrasli </div>
              </div>
            ...
            <div class='res_info_item'>
              <div class='res_info_tooltip_container'>
                ...
                <div class='res_info_tooltip'> Deca </div>
              </div>
        ...
        <div class='res_info_section'>
          <div class='res_info_item'>
            <div class='res_info_tooltip_container'>
              ...
              <div class='res_info_tooltip biggest'> Jedinice </div>
            </div>
          ...
          <div class='res_info_item'>
            ...
            <div class='res_info_text'> ${parseFloat(res.total_price).toFixed(2)} ${currency} </div>
          </div>
          ${note_html}
          ${cc_html}
        </div>
      ...
      <div class='res_info_buttons'>
        ...
        <div class='res_info_tooltip_container'>
          ...
          <div class='res_info_tooltip'> Štampaj </div>
        </div>
        <div class='res_info_tooltip_container'>
    ...
    `);
  // Remove unaccessable
  if(account_access.reservations < 3 && !(account_access.reservation == 2 && res.created_by == user_id)){
    $(".res_info_delete").remove();
    $("#res_info_noshow").remove();
    $("#res_info_invalidcc").remove();
    $("#res_info_edit").remove();
  }
  if(account_access.invoices < 2){
    $("#res_info_invoice").remove();
  }
...
function open_guest_info(guest_id)
{
  ...
  $("body").append(`
    <div class='info' id='guest_info'>
      ...
      <div class='flex_around'>
        ...
        <div class='res_info_section'>
          ...
          <div class='res_info_item'>
            <img class='res_info_icon' src='img/night_white.svg'>
            <div class='res_info_text'> ${guest.total_nights} noćenja </div>
          </div>
          <div class='res_info_item'>
            <img class='res_info_icon' src='img/price_tag_white.svg'>
            <div class='res_info_text'> ${guest.total_paid} ${currency} </div>
          </div>
          ${note_html}
        </div>
      </div>
    ...
    if(account_access.guests < 3 && !(account_access.guests == 2 && guest.created_by == user_id)){
      $("#guest_info_register").remove();
      $("#guest_info_edit").remove();
    }
  var scroll = $("html").scrollTop() > $("body").scrollTop() ? $("html").scrollTop() : $("body").scrollTop();
  $(".info").css("top", scroll+"px");
