...
function invoice_html(loc, invoice, row_number) {
  ...
  var invoice_edit = "";
  var invoice_delete = "";
  if(account_access.invoices == 3 || (account_access.invoices == 2 && invoice.created_by == user_id)){
    invoice_edit = `<div class='list_action'><img class='list_action_icon edit' title='Izmjeni' id='invoice_edit_${id}'> </div>`;
    invoice_delete = `<div class='list_action'><img class='list_action_icon delete' title='Obriši' id='invoice_delete_${id}'> </div>`;
  }
