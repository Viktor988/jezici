...
$("#new_reservation").click(function(){
  // Clear values
  $("#form_res main-title-form").text("Nova rezervacija");
  // Step 1
  $("#form_res_id").val("");
  ...
  $("#form_res_channel_select").text("Privatna rezervacija");
  ...
  $("#res_rooms_list").append(`
        <div class="room filter-step1 filter-step1--new room_row" id="form_res_room_${+(date)}">
          ...
          <div class="number-rooms number-rooms--night">
            <span class="text-form">Cijena po noćenju</span>
  ...
  $("#form_res_guests").append(`
        <div class="add-name-username flex_around form_res_guest" id='form_res_guest_${+(new Date())}'>
           ...
           <div class='vert_center'>
               <input  class="custom-input form_res_guest_name" type="text" placeholder="Ime">
           </div>
           <div class='vert_center'>
               <input  class="custom-input form_res_guest_surname" type="text" placeholder="Prezime">
           </div>
           <div class='vert_center'>
          ...
          <div class='vert_center'>
               <div class='flex_center'>
                <div class='list_action custom-icons-forms'><img  src='img/new-icons/edit-name-surname.svg' class='list_action_icon edit' title='Ostali podaci'> </div>
                <div class='list_action custom-icons-forms'><img src='img/new-icons/delete-name-surname.svg'  class='list_action_icon delete' id="guestdelete" title='Obriši'> </div>
              </div>
          </div>
       </div>`);
  ...
  $("#form_res_services").append(`
    <div class="additional-services form_res_service" >
      <div class="inputs-additional-services ">
        <input type="text" class="text_input custom-input form_res_service_name" placeholder="Usluga">
        <input type="text" class="number_input custom-input form_res_service_price" placeholder="Cijena" >
        <input type="text" class="number_input custom-input form_res_service_amount" placeholder="Količina" >
        <input type="text" class="number_input custom-input form_res_service_tax" placeholder="Porez (%)" >
        <input id="serviceTotal" type="text" class="number_input custom-input form_res_service_total form_readonly" readonly placeholder="Ukupna cijena" >
      </div>
      <div class="icons">
...
$("#form_res_confirm").click(function(){
  ...
  $.ajax({
    ...
    success: function(rezultat){
      ...
      if(id == "")
        add_change(`Dodata rezervacija`, sve.data.id); // Add changelog
      else
...
function open_reservation_form(res){
  ...
  // Fill values
  $("#form_res main-title-form").text("Ažuriranje rezervacije");
    ...
    success: function(rezultat){
      ...
      for(let i=0;i<res.guests.length;i++){
        ...
        $("#form_res_guests").append(`
              <div class="add-name-username flex_around form_res_guest" id='form_res_guest_${+(new Date()) + Math.floor(Math.random() * 100)}'>
                 ...
                 <div class='vert_center'>
                     <input  class="custom-input form_res_guest_name" type="text" placeholder="Ime" value='${res.guests[i].name}'>
                 </div>
                 <div class='vert_center'>
                     <input  class="custom-input form_res_guest_surname" type="text" placeholder="Prezime" value='${res.guests[i].surname}'>
                 </div>
                 <div class='vert_center'>
                     <input  type="hidden" class="text_input form_res_guest_email">
                 </div>
                ...
                <div class='vert_center'>
                     <div class='flex_center'>
                      <div class='list_action custom-icons-forms'><img  src='img/new-icons/edit-name-surname.svg' class='list_action_icon edit' title='Dodatni podaci'> </div>
                      <div class='list_action custom-icons-forms'><img src='img/new-icons/delete-name-surname.svg'  class='list_action_icon delete' id="guestdelete" title='Obriši'> </div>
                    </div>
                </div>
             </div>`);
      ...
      for(let i=0;i<res.services.length;i++){
        $("#form_res_services").append(`
          <div class="additional-services form_res_service" >
            <div class="inputs-additional-services ">
              <input type="text" class="text_input custom-input form_res_service_name" placeholder="Usluga" value='${res.services[i].name}'>
              <input type="text" class="number_input custom-input form_res_service_price" placeholder="Cijena" value='${res.services[i].price}'>
              <input type="text" class="number_input custom-input form_res_service_amount" placeholder="Količina" value='${res.services[i].amount}'>
              <input type="text" class="number_input custom-input form_res_service_tax" placeholder="Tax (%)" value='${res.services[i].tax}'>
              <input id="serviceTotal" type="text" class="number_input custom-input form_res_service_total form_readonly" readonly placeholder="Ukupna cijena" value='${res.services[i].total_price}'>
            </div>
            <div class="icons">
              <div class="list_action custom-icons-forms">
                <img id="deleteService" class="ml-10 list_action_icon delete" src="img/new-icons/delete-name-surname.svg" alt="">
