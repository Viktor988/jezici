...
if($action == "forgotPassword")
{
    ...
    $code = sha1($email . $username . time());
    $sql = "UPDATE all_users SET pwd = '$code' WHERE email = '$email'";
    $rezultat = mysqli_query($konekcija, $sql);
    if($rezultat){
      $subject = 'Reset password';
      $message = "To reset your password for admin.otasync.me click on: https://admin.otasync.me/reset?key=$code";
