...
function res_html(loc, res){
  ...
  if(account_access.reservations == 3 || (account_access.reservation == 2 && res.created_by == user_id)){
    res_edit = `<div class='list_action'><img class='list_action_icon edit' title='Edit'> </div>`;
    res_delete = `<div class='list_action'><img class='list_action_icon delete' title='Delete'> </div>`;
  }
  if(account_access.invoices >= 2){
    res_invoice = `<div class='list_action'><img class='list_action_icon invoice' title='Invoice'> </div>`;
  }
