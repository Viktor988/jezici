...
function guest_html(loc, guest, row_number) {
  ...
  if(account_access.guests == 3 || (account_access.guests == 2 && guest.created_by == user_id)){
    guest_edit = `<div class='list_action'><img class='list_action_icon edit' title='Edit'> </div>`;
    guest_delete = `<div class='list_action'><img class='list_action_icon delete' title='Delete'> </div>`;
  }
  if(account_access.reservations >= 2){
    guest_reservation = `<div class='list_action'><img class='list_action_icon reservation' title='Reservation'> </div>`;
  }
  var ret_val = `
