...
function invoice_html(loc, invoice, row_number) {
  ...
  if(account_access.invoices == 3 || (account_access.invoices == 2 && invoice.created_by == user_id)){
    invoice_edit = `<div class='list_action'><img class='list_action_icon edit' title='Edit' id='invoice_edit_${id}'> </div>`;
    invoice_delete = `<div class='list_action'><img class='list_action_icon delete' title='Delete' id='invoice_delete_${id}'> </div>`;
  }
