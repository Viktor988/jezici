...
$(document).ready(function(){
  ...
  // Datepicker moved to init after login because of date format
  ...
  $("#statistics_export").click(function(){
    var dfrom = date_to_iso($("#stat_dfrom").datepicker().data('datepicker').selectedDates[0]);
    var dto = date_to_iso($("#stat_dto").datepicker().data('datepicker').selectedDates[0]);
    $("#statistics_export_key").val(main_key);
    $("#statistics_export_account").val(account_name);
    $("#statistics_export_lcode").val(main_lcode);
    $("#statistics_export_dfrom").val(dfrom);
    $("#statistics_export_dto").val(dto);
    $("#statistics_export_values").val(JSON.stringify(stats));
