  ...
  $("#res_rooms_list").append(`
        <div class="room filter-step1 filter-step1--new room_row" id="form_res_room_${+(date)}">
          ...
          <div class="number-rooms number-rooms--night">
            <span class="text-form">Cena po noćenju</span>
  ...
  $("#form_res_services").append(`
    <div class="additional-services form_res_service" >
      <div class="inputs-additional-services ">
        ...
        <input type="text" class="number_input custom-input form_res_service_price" placeholder="Cena" >
        ...
        <input id="serviceTotal" type="text" class="number_input custom-input form_res_service_total form_readonly" readonly placeholder="Ukupna cena" >
      </div>
      <div class="icons">
        ...
        $("#form_res_services").append(`
          <div class="additional-services form_res_service" >
            <div class="inputs-additional-services ">
              ...
              <input type="text" class="number_input custom-input form_res_service_price" placeholder="Cena" value='${res.services[i].price}'>
              ...
              <input id="serviceTotal" type="text" class="number_input custom-input form_res_service_total form_readonly" readonly placeholder="Ukupna cena" value='${res.services[i].total_price}'>
            </div>
            <div class="icons">
              <div class="list_action custom-icons-forms">
                <img id="deleteService" class="ml-10 list_action_icon delete" src="img/new-icons/delete-name-surname.svg" alt="">
