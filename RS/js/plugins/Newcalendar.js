...
! function(t, e) {
    ...
    return a.prototype = {
        ...
        updateCalendars: function() {
            ...
            this.renderCalendar("left"), this.container.find(".ranges li").removeClass("active"), null != this.endDate && this.calculateChosenLabel()
        },
        ...
        outsideClick: function(t) {
            var a = e(t.target);
            "focusin" == t.type || a.closest(this.element).length || a.closest(this.container).length || a.closest(".calendar-table").length || (this.element.trigger("outsideClick.daterangepicker", this))
        },
        ...
        clickRange: function(t) {
            ...
            if (this.chosenLabel = e, e == this.locale.customRangeLabel) this.showCalendars();
                ...
                var a = this.ranges[e];
                this.startDate = a[0], this.endDate = a[1], this.timePicker || (this.startDate.startOf("day"), this.endDate.endOf("day")), this.alwaysShowCalendars || this.hideCalendars()
            }
        },
        ...
        clickCancel: function(t) {
            this.startDate = this.oldStartDate, this.endDate = this.oldEndDate,  this.element.trigger("cancel.daterangepicker", this)
        },
