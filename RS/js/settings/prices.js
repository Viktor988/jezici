        ...
        $(`#${row_id}`).after(`
          ...
          <input type='hidden' id='edit_restriction_id' value='${id}'>
            ...
            <div class='flex_between'>
              ...
              <div class="vert_center">
                <div>Min. boravak za dolaske</div>
            ...
            <div class='flex_center'>
              ...
              <button class='confirm_button' id='edit_restriction_compact_confirm'> SAČUVAJ </button>
            </div>
          </div>`);
